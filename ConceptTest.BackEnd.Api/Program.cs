...
using ConceptTest.BackEnd.Api.Filters;
using Elastic.Apm.NetCoreAll;
using Elastic.Apm.SerilogEnricher;
using ConceptTest.BackEnd.Infrastructure.Context;
using ConceptTest.BackEnd.Infrastructure.Extensions;
using MediatR;
...
builder.Services.AddMediatR(Assembly.Load("ConceptTest.BackEnd.Application"), typeof(Program).Assembly);
builder.Services.AddAutoMapper(Assembly.Load("ConceptTest.BackEnd.Application"));
