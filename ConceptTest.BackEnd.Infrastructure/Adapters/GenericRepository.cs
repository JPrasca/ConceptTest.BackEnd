...
namespace ConceptTest.BackEnd.Infrastructure.Adapters {
    
    public class GenericRepository<E> : IGenericRepository<E> where E : ConceptTest.BackEnd.Domain.Entities.Base.DomainEntity
    {
